...
public class AddColumnIcon extends AbstractRecolorableIcon {
    ...
    protected void finalizeColors() {
        gradient = new GradientPaint(4, 0, green, //
                9, 4, PaintUtils.mixColors(green, Color.black, 0.5f));
    }

    @Override
    protected void paintIcon(Graphics2D g2, Shape clip, float scale) {
        g2.setColor(white);
        g2.fillRect(0, 0, 13, 8);

        g2.setStroke(new BasicStroke(1 / scale));
        g2.setColor(edge);
        g2.drawRect(0, 0, 13, 8);
