...
public class TimeCardDialog {
    ...
    private class TimeCard extends AbstractTreeTableModel {
        ...
        private class TimeCardNode {
            ...
            public TimeCardNode(PSPProperties props) {
        ...
        public TimeCard(PSPProperties props, TimeLog timeLog) {
            super(null);
            Calendar cal = Calendar.getInstance();
            cal.setTime(new Date());
            recalc(props, timeLog, cal.get(cal.MONTH), cal.get(cal.YEAR));
        }
        ...
        public void recalc(PSPProperties props, TimeLog timeLog,
            ...
            while (e.hasMoreElements()) {
                ...
                cal.setTime(tle.createTime);
                day = cal.get(cal.DAY_OF_MONTH);

                root.addTime(tle.key.path(), day, tle.minutesElapsed);
                time[0] += tle.minutesElapsed;
                time[day] += tle.minutesElapsed;
            }
            root.prune();
            this.root = root;
