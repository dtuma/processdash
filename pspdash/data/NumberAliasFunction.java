...
class NumberAliasFunction extends DoubleData implements DataListener {
    ...
    public NumberAliasFunction(String name, String params, String saveAs,
    ...
    public void dataValueChanged(DataEvent e) {
        if (e.getName().equals(aliasOf)) try {
            DoubleData d = (DoubleData) e.getValue();
            value = d.getDouble();
            defined = d.isDefined();
