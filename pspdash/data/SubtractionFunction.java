...
class SubtractionFunction extends DoubleData implements NumberFunction {
    ...
    public SubtractionFunction(String name, String params, String saveAs,
        ...
        if (args.hasMoreElements()) {
            ...
            try {
                ...
                addend = new SumList(data, parameter, prefix, this, name);
            }}
        }
    ...
    public void dispose() {
        name = saveValue = null;
        if (addend != null) { addend.dispose(); addend = null; }
        if (datalists != null) {
            for (int i = datalists.size();   i-- > 0; )
