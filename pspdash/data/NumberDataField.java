...
public class NumberDataField extends FormTextField {

    int numberOfDigits;

    NumberDataField(Repository r, JSObject o, String name, String defaultValue,
    ...
    void parse() throws MalformedValueException {
        String text = getText();
        value = ((text.length() == 0) ? null : new DoubleData(text));
    }
}
