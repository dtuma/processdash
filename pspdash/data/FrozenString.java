...
public class FrozenString extends StringData implements FrozenData {
    ...
    public FrozenString(String name, String s, DataRepository data,
                        String prefix) throws MalformedValueException
    {
        this(name, new FrozenUtil(s), data, prefix);
    }

    private FrozenString(String name, FrozenUtil util, DataRepository data,
                         String prefix) throws MalformedValueException {
