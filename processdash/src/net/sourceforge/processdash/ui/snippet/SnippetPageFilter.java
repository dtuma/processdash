...
public interface SnippetPageFilter {

    /**
     * Possibly make some change to the content of a page.
     * 
     * @param page
     *            the page
     * @param snippet
     *            the snippet which produced this filter
     * @param mode
     *            the rendering mode for the page
     */
