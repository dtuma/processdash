...
public abstract class RBAbstractQuery extends AbstractBoundQuery<RBRestClient> {

    public RBAbstractQuery(BoundMap map, Element xml) {
        super(map, xml, RBConnection.DEFAULT_ID);
    }
    ...
    protected static final ErrorValue RB_REST_ERROR_VALUE = new ErrorValue(
