...
public class FilterDataContainingWorkflowNames extends AbstractDataStringFilter {

    private HierarchyPathMapper pathNameMapper;

    @EnabledFor("Workflow_Name")
    public String scrambleWorkflowName(String name) {
        return pathNameMapper.getString(name);
    }
