...
import net.sourceforge.processdash.log.ui.DefectLogEditor.DefectListEntry;


public class DefectLogSelection implements Transferable {

    public static final DataFlavor FLAVOR = new Flavor();


    private List<DefectListEntry> defects;

    private String text;

    public DefectLogSelection(List<DefectListEntry> defects, String text) {
    ...
    private static class Flavor extends DataFlavor {
        public Flavor() {
            super(DataFlavor.javaJVMLocalObjectMimeType + "; class="
                    + DefectLogSelection.class.getName(), "Defect Log Data");
        }
    };
